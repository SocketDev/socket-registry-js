...
declare function whichCollection<K extends WeakKey, V>(
  value: WeakMap<K, V>
): 'WeakMap'
declare function whichCollection<T extends WeakKey>(
  value: WeakSet<T>
): 'WeakSet'
declare function whichCollection(
  value: null | undefined | boolean | number | bigint | symbol | unknown
): false
